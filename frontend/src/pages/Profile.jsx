  ...
  const handleDeleteListing = async (listingId) => {
    try {
      ...
      setShowUserListings((prev) => ({
        ...
        data: {
          ...prev.data,
          listings: prev.data.listings.filter(
    ...
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <img
          ...
          src={formData.photo || currentUser.data.userData.photo}
          alt="profile-photo"
        />
        <p className="text-sm self-center">
          {fileUploadError ? (
            <span className="text-red7-700">
              Error image upload (File must be less than 10MB)
            </span>
        ...
        rounded-lg uppercase hover:opacity-80 text-center"
          to={'/create-listing'}
        >
          Create Listing
        </Link>
      ...
      {showUserListings &&
        ...
        showUserListings.data.listings &&
