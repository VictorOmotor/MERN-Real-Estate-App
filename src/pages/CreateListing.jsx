    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <input type="textarea" className='border p-3 rounded-lg' placeholder='Description' id='descfiption' required/>
                <input type="text" className='border p-3 rounded-lg' placeholder='Address' id='name'  required/>
                ...
                <div className='flex gap-2'>
                    <input type="checkbox" id='soffer' className='w-5' />
                    <span>Offer</span>
                </div>
            </div>
            <div className='flex flex-wrap gap-5'>
                ...
                <div className='flex items-center gap-2'>
                    <input type="number" id='regularPrice' min={1} max={10} required className='p-1
                    border border-gray-300 rounded-lg' />
                ...
                <div className='flex items-center gap-2'>
                    <input type="number" id='discountPrice' min={1} max={10} required className='p-1
                    border border-gray-300 rounded-lg' />
                    <div className='flex flex-col items-center'>
            ...
            <div className="flex flex-col flex-1 gap-4" >
                ...
                <div className="flex gap-4">
                   ...
                   <button className='p-1 text-gray-400 border border-green-700
